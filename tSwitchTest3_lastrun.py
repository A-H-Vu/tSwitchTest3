...
expName = 'tSwitchTest3'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Andrew\\Documents\\Work\\Projects\\tSwitchTest3\\tSwitchTest3_lastrun.py',
...
instrText = visual.TextStim(win=win, name='instrText',
    ...
    languageStyle='LTR',
    depth=0.0);
instrText.text = "Space to continue."
